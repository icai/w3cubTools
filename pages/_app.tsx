...
import "@styles/image-to-text/modal.css";
import "@styles/image-to-text/imagePreviewUpload.css";
import "@styles/image-to-text/transformSetting.css";
import "@styles/image-to-text/index.scss";
import "@styles/g2048/index.scss";
